...
public class ParallelogramMapper extends ImageMapper {
  ...
  /**
   * Note: The first vector (v1) maps to the height of the image, the second vector (v2) maps to the
   * width of the image.
   */
  public ParallelogramMapper(
  ...
  private double getComponentInDirection(
      Vector unitVectorToHit, double vectorToHitMag, Vector unitDirection) {
