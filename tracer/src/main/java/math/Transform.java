...
public class Transform {
  ...
  /**
   * I will use the axis angle method + Rodrigues' Rotation Formula to calculate the rotation of the
   * ray/eye point. I will convert the rotation formula to matrix notation, so I can get the inverse
   * and move back and forth. I pulled the formula for the rotation matrix equivalent from the
   * Wikipedia article for Rodrigues' Rotation Formula.
   *
   * @param incomingLocalSurfaceDirection The direction the surface is pointed by default. This
   *     helps set up the rotation axis.
   * @param incomingWorldDirection The direction the surface is pointed in world coordinates. This
   *     sets up the rotation axis.
  ...
  public Transform(
    ...
    Matrix4 crossProductMatrixOfAxis =
        new Matrix4(
