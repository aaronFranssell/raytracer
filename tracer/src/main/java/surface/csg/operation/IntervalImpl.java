		...
		for(int i = 0; i < other.length; i+=2)
		{
			for(int k = unusedIntervalIndex; k < interval.length; k+=2)
			{
				...
				//only add these if we are at the beginning or end of other, since a later interval may truncate these
						...
						!(contains.containsKey(Double.valueOf(interval[k])) || contains.containsKey(Double.valueOf(interval[k+ 1]))))
				{
					unusedIntervalIndex += 2;
				...
				//the first hit point is in the other's interval
						...
						!(contains.containsKey(Double.valueOf(other[i + 1])) || contains.containsKey(interval[k + 1])))
				{
				...
				//the second hitpoint is in the other's interval
						...
						!(contains.containsKey(Double.valueOf(other[i])) || contains.containsKey(interval[k])))
				{
					contains.put(Double.valueOf(interval[k]), Double.valueOf(interval[k]));
				...
				//other's interval is between this's interval
						...
						!(contains.containsKey(Double.valueOf(interval[k])) || contains.containsKey(interval[k + 1])))
				{
					contains.put(Double.valueOf(interval[k]), Double.valueOf(interval[k]));
					contains.put(Double.valueOf(interval[k + 1]), Double.valueOf(interval[k + 1]));
					unusedIntervalIndex += 2;
