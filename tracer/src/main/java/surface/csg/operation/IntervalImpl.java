...
public class IntervalImpl implements Interval {
	...
	/**
	 * This function will return the closest "t" value that is beyond the incoming "t" value. This is useful for determining if a "t" value is bounded
	 * by another solid.
	 *
	 * @param smallestT
	 *            The smallestT we are testing to see if it is in an interval.
