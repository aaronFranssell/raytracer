...
public abstract class Surface {
	...
	public static enum SurfaceType {
		Cylinder, Sphere, Outersphere, Torus, Triangle, Plane, CSGTree, Cone, Parallelogram, Bezier
	};
	...
	public Color getColor(Ray r, Point light, Point eye, boolean inShadow, Vector n, Point p)
		...
		if (effects.getPhong() != null) {
			return ops.getColorPhong(
					currentCR, cA, cL, normal, light, eye, effects.getPhong().getExponent(), p, inShadow);
