...
public class Matrix4_UnitTests {
	...
	public void multiply_WithOtherMatrix_ExpectResult() {
		...
		Matrix4 other = new Matrix4(
				3.0, 5.0, 0.0, -5.0, -5.0, -7.0, 11.0, -1.0, 7.0, -3.0, 5.0, -7.0, 3.0, -1.0, -7.0,
				-2.0);
		Matrix4 classUnderTest = new Matrix4(
				1.0, 0.0, -5.0, 3.0, 5.0, -3.0, 2.0, 13.0, -7.0, 7.0, 5.0, -11.0, -3.0, 3.0, 11.0, 2.0);
	...
	public void multiplyBy_WithValues_ExpectScaledMatrix() {
		...
		Matrix4 classUnderTest = new Matrix4(
				1.0, 0.0, 3.0, -3.0, -1.0, 5.0, -5.0, 7.0, 3.0, 2.5, 6.0, 0.0, 0.0, -2.5, 5.0, 9.0);
		double scaleBy = -2.0;
	...
	public void getInverse_WithMatrix_ExpectInverse() {
		...
		Matrix4 answerMatrix = new Matrix4(
				-2.3, -0.6, 0.9, -0.3, 0.744, 0.288, -0.152, 0.024, 0.84, 0.18, -0.22, 0.14, -0.26,
				-0.02, 0.08, 0.04);
	...
	public void add_WithOtherMatrix_ExpectMatrix() {
		...
		Matrix4 otherMatrix = new Matrix4(
				1.0, 0.0, 3.0, -3.0, -1.0, 5.0, -5.0, 7.0, 3.0, 2.5, 6.0, 0.0, 0.0, -2.5, 5.0, 9.0);

		Matrix4 answerMatrix = new Matrix4(
				2.0, 0.0, 6.0, -6.0, -2.0, 10.0, -10.0, 14.0, 6.0, 5.0, 12.0, 0.0, 0.0, -5.0, 10.0,
				18.0);
