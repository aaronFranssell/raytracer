...
public class Torus_IntegrationTests {
  ...
  public void constructor_WithDirectionParallelToSurface_ExpectDirectionOffset() {
    ...
    Torus classUnderTest =
        new Torus(center, direction, largeR, smallR, null, null, null, null, null);
  ...
  public void getHitData_WithMiss_ExpectNoHitData() {
    ...
    Torus classUnderTest =
        new Torus(center, direction, largeR, smallR, null, null, null, null, new UtilImpl());
  ...
  public void getHitData_With4Hits_ExpectHitData() {
    ...
    HitData hit =
        new HitData(1.25, classUnderTest, new Vector(0.0, 0.0, 1.0), new Point(0.0, 0.0, 2.75));
    expected.add(hit);
  ...
  public void getHitData_With2Hits_ExpectHitData() {
    ...
    HitData hit =
        new HitData(
            4.272963481788047,
            classUnderTest,
            new Vector(0.0, -0.021861131371787714, -0.9997610169111143),
            new Point(0.0, 0.0, -0.272963481788046));
    expected.add(hit);
    hit =
        new HitData(
            3.727036319405667,
            classUnderTest,
            new Vector(0.0, -0.021861129007357066, 0.9997610169628158),
            new Point(0.0, 0.0, 0.27296368059433335));
    expected.add(hit);
