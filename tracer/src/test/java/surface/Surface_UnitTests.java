...
public class Surface_UnitTests {
	@Test
	public void getColor_WithNoLightingModel_ExpectException() throws Exception {
	...
	@Test
	public void getColor_WithPhongAndMockedBumpAndNose_ExpectCalls() throws Exception {
		...
		Mockito.when(
				mockUtil.getColorPhong(
						cR, mockCA, mockCL, mockedBumpVector, light, eye, exponent, p, inShadow))
				.thenReturn(phongColor);
	...
	@Test
	public void getColor_WithLambertian_ExpectCalls() throws Exception {
		...
		Util mockUtil = Mockito.mock(Util.class);
		Mockito.when(mockUtil.getColorLambertian(cR, mockCA, mockCL, n, light, p, inShadow))
				.thenReturn(lambertianColor);
