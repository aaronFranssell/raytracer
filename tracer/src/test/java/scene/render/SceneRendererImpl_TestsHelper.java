...
public class SceneRendererImpl_TestsHelper {
  public static RenderResult getResult() throws Exception {
    ...
    cR = new Color(0.0, 0.0, 0.0);
    OuterSphere background =
        new OuterSphere(effects, cR, new Color(0.7, 0.7, 0.7), new Color(0.7, 0.7, 0.7));
    ...
    center = new Point(2.0, 0.0, 0.0);
    Torus torus =
        new Torus(center, new Vector(1.0, 1.0, 1.0), 1.25, 0.25, cR, Constants.cA, cL, effects);
    ...
    cR = new Color(0.0, 0.0, 0.0);
    ParallelogramMapper parallelogramMapper =
        new ParallelogramMapper(
    ...
    Parallelogram parallelogram =
        new Parallelogram(parallelogramBasePoint, v1, v2, cR, cL, Constants.cA, effects);
    ...
    effects.setReflective(true);
    Cone cone =
        new Cone(direction, vertex, alpha, basePoint, length, cR, Constants.cA, cL, effects);
