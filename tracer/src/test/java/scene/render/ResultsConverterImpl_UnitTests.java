...
public class ResultsConverterImpl_UnitTests {
  ...
  @Test
  public void getImageFromResults_WithMocks_ExpectImage()
    ...
    ResultsConverterImpl classUnderTest =
        new ResultsConverterImpl(resultsList, width, height, mockScaler, mockImage);
    ...
    Mockito.verify(mockScaler, Mockito.times(1))
        .scale(argThat(new ResultsConvertImplArugmentMatcher(combinedArray)));
