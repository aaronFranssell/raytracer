...
public class RenderThreadImpl_UnitTests {
  ...
  public void call_WithValidParameters_ExpectFactoryCalls() throws Exception {
    ...
    int height = 40;
    UVW basis =
        new UVW(new Vector(1.0, 0.0, 0.0), new Vector(0.0, 1.0, 0.0), new Vector(0.0, 0.0, 1.0));
    ...
    RayFactory mockRayFactory =
        RenderThreadImpl_TestsHelper.getMockRayFactory(
    ...
    RenderThreadImpl classUnderTest =
