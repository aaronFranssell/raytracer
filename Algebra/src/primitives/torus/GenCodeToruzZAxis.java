...
public class GenCodeToruzZAxis
{
	public static void main(String[] args)
	{
		...
		//((px + tdx)2 + (py + tdy)2 + (pz + tdz)2 - r2 - R2)2 + 4R2((pz + tdz)2 - r2)
		//       tdx
		...
		//((px + tdx)^2 + (py + tdy)^2 + (pz + tdz)^2 - r^2 - R^2)^2 + 4R^2((pz + tdz)^2 - r^2)
		//											  - r^2
		...
		//((px + tdx)^2 + (py + tdy)^2 + (pz + tdz)^2 - r^2 - R^2)^2 + 4R^2((pz + tdz)^2 - r^2)
		//((px + tdx)^2 + (py + tdy)^2 + (pz + tdz)^2 - r^2 - R^2)^2
