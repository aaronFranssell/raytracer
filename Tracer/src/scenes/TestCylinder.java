...
public class TestCylinder
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		Ray r;
		Color cR = new Color(0.0,0.5,0.0);
		float red = (float) 0.0;
		...
		Point bottomCylinder = new Point(-1.5,0.0,0.0);
		effects = new Effects();
		...
		Cylinder c3 = new Cylinder(bottomCylinder, 0.5, cR, Constants.cA, cL, 3.0, new Vector(1.0,0.0,0.0), effects);
