...
public class StopWatchImpl_UnitTests
{
	...
	public void start_WithMocks_ExpectCall()
	{
		...
		//Then
		Assert.assertTrue(classUnderTest.getStart().equals(begin));
	}
	...
	public void stop_WithMocks_ExpectCall()
	{
		...
		//Then
		Assert.assertTrue(classUnderTest.getEnd().equals(end));
	}
	...
	public void getDifference_WithStartAndStopNotCalled_ExpectErrorMessage()
	{
		...
		//Then
		Assert.assertEquals("Start and stop were not called on the stopwatch.", ret);
	}
	...
	public void getDifference_WithStartNotCalled_ExpectErrorMessage()
	{
		...
		//Then
		Assert.assertEquals("Start was not called on the stopwatch.", ret);
	}
	...
	public void getDifference_WithStopNotCalled_ExpectErrorMessage()
	{
		...
		//Then
		Assert.assertEquals("Stop was not called on the stopwatch.", ret);
	}
	...
	public void getDifference_StopCalledBeforeStart_ExpectErrorMessage()
	{
		...
		//Then
		Assert.assertEquals("The stopwatch was stopped before it was started.", ret);
	}
	...
	public void getDifference_WithMocks_ExpectDifferenceMessage()
	{
		...
		//Then
		Assert.assertEquals("Executed in 41 minute(s) and 53 seconds.", ret);
	}
}
