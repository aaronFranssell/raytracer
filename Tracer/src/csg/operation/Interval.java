...
public class Interval
{
	...
	public Interval(double[] incomingInterval, Util incomingOps) throws RaytracerException
	{
		MyAssert.notNull(incomingInterval);
		MyAssert.notNull(incomingOps);
	...
	public double getNearInterval(double smallestT) throws RaytracerException
	{
		...
		throw new RaytracerException("Not a valid smallestT for the interval!");
	}
